...
public class Etape3Service {
    ...
    private final String etape3Texte = "<!gDTvBUW sOlX>\n" +
            ...
            "        \"<d suxV=\"ldKXOp:uxRuoOxlxZO@KGGpZ.Vu\">uxRuoOxlxZO@KGGpZ.Vu</d>\", dNxR fdZY Xx OKOux fx NpOux lxYYdqx \"[mGGpZ-jxRuoOx-3]\".\n" +
            "    </G>\n" +
            "\n" +
            "    <G>\n" +
            "        Upou dNpKu fxY GpKZOY ApZoY XpuY fx NpOux xZOuxOKxZ,\n" +
            "        YK NpoY dNxF oOKXKY&xdRoOx; oZx l&xdRoOx;Ospfx dloYdZOx Gpou u&xdRoOx;Ypofux X'oZ fxY GoFFXxY\n" +
            "        (Gdu xwxlGXx fx X'KZExROKpZ fx Rpfx QdNdCRuKGO fdZY Xd GuxlK&xqudNx;ux &xdRoOx;OdGx...),\n" +
            "        NpoY GpoNxF f&xdRoOx;RuKux Xd l&xdRoOx;Ospfx oOKXKY&xdRoOx;x xO udEpoOxu xZ RpGKx\n" +
            "        \"QoXKxZ goApKY &XO;EfoApKY@KGGpZ.Vu&qO;\", LoK Yx Vxud oZ GXdKYKu f'&xdRoOx;OofKxu NpOux Rpfx !\n" +
            "    </G>\n" +
            "\n" +
            "    <G>\n" +
            "        h AKxZO&pRKuR;O,\n" +
